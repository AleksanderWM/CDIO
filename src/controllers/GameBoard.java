...
public class GameBoard {
	...
	public void CreateBoard(){
		...
		FieldList.add(new RailRoad(TxtList[5],"4000",Color.BLUE,noOwner,4000,500));
		...
		FieldList.add(new Utility(TxtList[12],"3000",noOwner,3000,100));
		...
		FieldList.add(new RailRoad(TxtList[15],"4000",Color.BLUE,noOwner,4000,500));
		...
		FieldList.add(new RailRoad(TxtList[25],"4000",Color.BLUE,noOwner,4000,500));
		...
		FieldList.add(new Utility(TxtList[28],"3000",noOwner,3000,100));
		...
		FieldList.add(new RailRoad(TxtList[35],"4000",Color.BLUE,noOwner,4000,500));
		FieldList.add(new TryYourLuck());
		FieldList.add(new Property(TxtList[37],"7000",new Color(150,53,150),noOwner,7000,700));
		FieldList.add(new PercentageTax());
		FieldList.add(new Property(TxtList[39],"8000",new Color(150,53,150),noOwner,8000,1000));
	}
