...
public class GameBoard {
	...
	public void CreateBoard(){
		...
		FieldList.add(new Property(TitleList[35],DescriptionList[35],SubtextList[34],Color.YELLOW,noOwner,6400,4000,600, 3000, 9000, 20000, 24000, 28000, 0, 0));
		...
		FieldList.add(new Property(TitleList[38],DescriptionList[38],SubtextList[8],new Color(150,53,150),noOwner,7000,4000,700, 3500, 10000, 22000, 26000, 30000, 0, 0));
